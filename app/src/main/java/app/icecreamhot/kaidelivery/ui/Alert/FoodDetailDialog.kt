...
import app.icecreamhot.kaidelivery.ui.order.Adapter.FoodDetailAdapter
...
class FoodDetailDialog: DialogFragment() {
    ...
    private fun initView(view: View) {
        var foodPrice = 0.0
        var allPrice = 0.0
        var deliveryPrice = mOrder.get(0).order_deliveryprice
        ...
        allPrice = foodPrice + deliveryPrice
